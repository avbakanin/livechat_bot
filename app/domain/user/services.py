...
from domain.user.queries import (
    ...
    get_user_consent as db_get_user_consent,
    set_user_consent as db_set_user_consent,
    get_gender_preference as db_get_gender_preference,
    set_gender_preference as db_set_gender_preference
)
