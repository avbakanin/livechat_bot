...
def get_help_text(free_limit: int = None, i18n_instance=None) -> str:
    ...
    return f"""{hbold(i18n_instance.t('commands.help.title'))}
...
{i18n_instance.t('commands.help.status_command')}
{i18n_instance.t('commands.help.language_command')}
{i18n_instance.t('commands.help.restart_command')}
{i18n_instance.t('commands.help.stop_command')}
