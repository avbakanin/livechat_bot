    ...
    def __init__(self):
        ...
        self.rules: Dict[str, RateLimitRule] = {
            "message": RateLimitRule(
                max_requests=30, time_window=60, block_duration=300
            ),
            "command": RateLimitRule(
                max_requests=10, time_window=60, block_duration=180
            ),
            "callback": RateLimitRule(
                max_requests=20, time_window=60, block_duration=120
            ),
            "language_change": RateLimitRule(
                max_requests=5, time_window=300, block_duration=600
            ),
        }
